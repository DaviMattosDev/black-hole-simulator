...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ho(e,t,n){let r=new Float32Array(Oo),i=new W(0,1,0);return new aa({name:`SphericalGaussianBlur`,defines:{n:Oo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Go(),fragmentShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Ql=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},$l=new Ba(-1,1,1,-1,0,1),eu=new class extends Vr{constructor(){super(),this.setAttribute(`position`,new kr([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new kr([0,2,0,0,2,0],2))}},tu=class{constructor(e){this._mesh=new ui(eu,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,$l)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},nu=class extends Ql{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof aa?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=na.clone(e.uniforms),this.material=new aa({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new tu(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},ru=class extends Ql{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},iu=class extends Ql{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},au=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new U);this._width=n.width,this._height=n.height,t=new cn(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:k}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new nu(Zl),this.copyPass.material.blending=0,this.timer=new Ka}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}ru!==void 0&&(r instanceof ru?n=!0:r instanceof iu&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new U);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},ou=class extends Ql{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new K}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},su={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new K(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
		...
		}`},cu=class e extends Ql{constructor(e,t=1,n,r){super(),this.strength=t,this.radius=n,this.threshold=r,this.resolution=e===void 0?new U(256,256):new U(e.x,e.y),this.clearColor=new K(0,0,0),this.needsSwap=!1,this.renderTargetsHorizontal=[],this.renderTargetsVertical=[],this.nMips=5;let i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);this.renderTargetBright=new cn(i,a,{type:k}),this.renderTargetBright.texture.name=`UnrealBloomPass.bright`,this.renderTargetBright.texture.generateMipmaps=!1;for(let e=0;e<this.nMips;e++){let t=new cn(i,a,{type:k});t.texture.name=`UnrealBloomPass.h`+e,t.texture.generateMipmaps=!1,this.renderTargetsHorizontal.push(t);let n=new cn(i,a,{type:k});n.texture.name=`UnrealBloomPass.v`+e,n.texture.generateMipmaps=!1,this.renderTargetsVertical.push(n),i=Math.round(i/2),a=Math.round(a/2)}let o=su;this.highPassUniforms=na.clone(o.uniforms),this.highPassUniforms.luminosityThreshold.value=r,this.highPassUniforms.smoothWidth.value=.01,this.materialHighPassFilter=new aa({uniforms:this.highPassUniforms,vertexShader:o.vertexShader,fragmentShader:o.fragmentShader}),this.separableBlurMaterials=[];let s=[6,10,14,18,22];i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);for(let e=0;e<this.nMips;e++)this.separableBlurMaterials.push(this._getSeparableBlurMaterial(s[e])),this.separableBlurMaterials[e].uniforms.invSize.value=new U(1/i,1/a),i=Math.round(i/2),a=Math.round(a/2);this.compositeMaterial=this._getCompositeMaterial(this.nMips),this.compositeMaterial.uniforms.blurTexture1.value=this.renderTargetsVertical[0].texture,this.compositeMaterial.uniforms.blurTexture2.value=this.renderTargetsVertical[1].texture,this.compositeMaterial.uniforms.blurTexture3.value=this.renderTargetsVertical[2].texture,this.compositeMaterial.uniforms.blurTexture4.value=this.renderTargetsVertical[3].texture,this.compositeMaterial.uniforms.blurTexture5.value=this.renderTargetsVertical[4].texture,this.compositeMaterial.uniforms.bloomStrength.value=t,this.compositeMaterial.uniforms.bloomRadius.value=.1;let c=[1,.8,.6,.4,.2];this.compositeMaterial.uniforms.bloomFactors.value=c,this.bloomTintColors=[new W(1,1,1),new W(1,1,1),new W(1,1,1),new W(1,1,1),new W(1,1,1)],this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,this.copyUniforms=na.clone(Zl.uniforms),this.blendMaterial=new aa({uniforms:this.copyUniforms,vertexShader:Zl.vertexShader,fragmentShader:Zl.fragmentShader,premultipliedAlpha:!0,blending:2,depthTest:!1,depthWrite:!1,transparent:!0}),this._oldClearColor=new K,this._oldClearAlpha=1,this._basic=new Qr,this._fsQuad=new tu(null)}dispose(){for(let e=0;e<this.renderTargetsHorizontal.length;e++)this.renderTargetsHorizontal[e].dispose();for(let e=0;e<this.renderTargetsVertical.length;e++)this.renderTargetsVertical[e].dispose();this.renderTargetBright.dispose();for(let e=0;e<this.separableBlurMaterials.length;e++)this.separableBlurMaterials[e].dispose();this.compositeMaterial.dispose(),this.blendMaterial.dispose(),this._basic.dispose(),this._fsQuad.dispose()}setSize(e,t){let n=Math.round(e/2),r=Math.round(t/2);this.renderTargetBright.setSize(n,r);for(let e=0;e<this.nMips;e++)this.renderTargetsHorizontal[e].setSize(n,r),this.renderTargetsVertical[e].setSize(n,r),this.separableBlurMaterials[e].uniforms.invSize.value=new U(1/n,1/r),n=Math.round(n/2),r=Math.round(r/2)}render(t,n,r,i,a){t.getClearColor(this._oldClearColor),this._oldClearAlpha=t.getClearAlpha();let o=t.autoClear;t.autoClear=!1,t.setClearColor(this.clearColor,0),a&&t.state.buffers.stencil.setTest(!1),this.renderToScreen&&(this._fsQuad.material=this._basic,this._basic.map=r.texture,t.setRenderTarget(null),t.clear(),this._fsQuad.render(t)),this.highPassUniforms.tDiffuse.value=r.texture,this.highPassUniforms.luminosityThreshold.value=this.threshold,this._fsQuad.material=this.materialHighPassFilter,t.setRenderTarget(this.renderTargetBright),t.clear(),this._fsQuad.render(t);let s=this.renderTargetBright;for(let n=0;n<this.nMips;n++)this._fsQuad.material=this.separableBlurMaterials[n],this.separableBlurMaterials[n].uniforms.colorTexture.value=s.texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionX,t.setRenderTarget(this.renderTargetsHorizontal[n]),t.clear(),this._fsQuad.render(t),this.separableBlurMaterials[n].uniforms.colorTexture.value=this.renderTargetsHorizontal[n].texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionY,t.setRenderTarget(this.renderTargetsVertical[n]),t.clear(),this._fsQuad.render(t),s=this.renderTargetsVertical[n];this._fsQuad.material=this.compositeMaterial,this.compositeMaterial.uniforms.bloomStrength.value=this.strength,this.compositeMaterial.uniforms.bloomRadius.value=this.radius,this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,t.setRenderTarget(this.renderTargetsHorizontal[0]),t.clear(),this._fsQuad.render(t),this._fsQuad.material=this.blendMaterial,this.copyUniforms.tDiffuse.value=this.renderTargetsHorizontal[0].texture,a&&t.state.buffers.stencil.setTest(!0),this.renderToScreen?(t.setRenderTarget(null),this._fsQuad.render(t)):(t.setRenderTarget(r),this._fsQuad.render(t)),t.setClearColor(this._oldClearColor,this._oldClearAlpha),t.autoClear=o}_getSeparableBlurMaterial(e){let t=[],n=e/3;for(let r=0;r<e;r++)t.push(.39894*Math.exp(-.5*r*r/(n*n))/n);return new aa({defines:{KERNEL_RADIUS:e},uniforms:{colorTexture:{value:null},invSize:{value:new U(.5,.5)},direction:{value:new U(.5,.5)},gaussianCoefficients:{value:t}},vertexShader:`
				...
				}`})}};cu.BlurDirectionX=new U(1,0),cu.BlurDirectionY=new U(0,1);function lu(e,t,n){return Math.min(n,Math.max(t,e))}function uu(e,t,n){return e+(t-e)*n}function du(e,t,n){let r=lu((n-e)/(t-e),0,1);return r*r*(3-2*r)}function fu(e){return e*e*e}function pu(e){return Math.min(.998,Math.max(0,e))}function mu(e){let t=pu(e);return 1+Math.sqrt(Math.max(0,1-t*t))}function hu(e){let t=pu(e);if(t<1e-9)return 6;let n=t*t,r=1+Math.cbrt(1-n)*(Math.cbrt(1+t)+Math.cbrt(1-t)),i=Math.sqrt(3*n+r*r);return 3+i-Math.sqrt(Math.max(0,(3-r)*(3+r+2*i)))}var gu=e((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n,e.jsxs=n})),$=e(((e,t)=>{t.exports=gu()}))(),_u=5e3,vu=116,yu=new W(0,0,0);function bu(e){return .72+Math.log10(Math.max(1,e))/10*.78}function xu(e){let t=(0,l.useRef)(e);return(0,l.useEffect)(()=>{t.current=e},[e]),t}var Su={uniforms:{tDiffuse:{value:null},uBlackHoleScreenPos:{value:new U(.5,.5)},uStrength:{value:0},uRadius:{value:.1},uTime:{value:0},uPsychedelic:{value:0}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    vec3 psychedelicColor(vec3 color, vec2 uv, float amount) {
      float pulse = 0.5 + 0.5 * sin(uTime * 9.0 + uv.x * 18.0 + uv.y * 12.0);
      vec3 neon = vec3(
        0.5 + 0.5 * sin(uTime * 4.2 + color.r * 6.0),
        0.5 + 0.5 * sin(uTime * 5.1 + color.g * 7.0 + 2.1),
        0.5 + 0.5 * sin(uTime * 6.0 + color.b * 8.0 + 4.2)
      );
      color = mix(color, color * (1.15 + pulse * 0.55), amount * 0.36);
      color = mix(color, neon, amount * 0.22);
      return color;
    }
    ...
    void main() {
      ...
      // Pulso psicodélico real no começo da entrada: ondulação + separação RGB + brilho.
      float amount = clamp(uPsychedelic, 0.0, 1.0);
      vec2 centerDelta = uv - uBlackHoleScreenPos;
      float centerDist = length(centerDelta);
      float radialWave = sin(centerDist * 56.0 - uTime * 13.0) * 0.5 + 0.5;
      float vortex = atan(centerDelta.y, centerDelta.x) + uTime * 2.2;
      vec2 swirl = vec2(cos(vortex), sin(vortex)) * amount * 0.010 * radialWave;
      vec2 waveOffset = normalize(centerDelta + 0.0001) * amount * 0.018 * sin(centerDist * 32.0 - uTime * 8.0);
      vec2 psychedelicUv = uv + waveOffset + swirl;

      float rgbSplit = amount * (0.006 + radialWave * 0.008);
      vec2 chromaDir = normalize(centerDelta + vec2(0.0001));
      float r = texture2D(tDiffuse, psychedelicUv + chromaDir * rgbSplit).r;
      float g = texture2D(tDiffuse, psychedelicUv).g;
      float b = texture2D(tDiffuse, psychedelicUv - chromaDir * rgbSplit).b;
      vec3 baseColor = texture2D(tDiffuse, uv).rgb;
      vec3 splitColor = vec3(r, g, b);
      vec3 color = mix(baseColor, splitColor, amount);

      color = psychedelicColor(color, psychedelicUv, amount);
      color += amount * radialWave * vec3(0.22, 0.12, 0.03);

      gl_FragColor = vec4(color, 1.0);
    }`};function Cu({params:e,entering:t,horizonFocus:n,spectatorMode:r,sequenceStartedAt:i,reducedMotion:a,onDoubleTapHorizon:o}){let s=(0,l.useRef)(null),c=xu(e),u=xu(t),d=xu(n),f=xu(r),p=xu(i),m=xu(a),h=xu(o);return(0,l.useEffect)(()=>{let e=s.current;if(!e)return;let t;try{t=new Al({antialias:!m.current,alpha:!1,powerPreference:`high-performance`})}catch{e.innerHTML=`<p style="color:#fff;padding:2rem">WebGL não suportado.</p>`;return}t.setClearColor(5,1),t.setPixelRatio(Math.min(window.devicePixelRatio,2)),t.outputColorSpace=Ye,t.toneMapping=4,t.toneMappingExposure=1.1,e.appendChild(t.domElement);let n=new qn,r=new La(54,1,.04,400);r.position.set(0,2.15,8.8);let i=new Rl(r,t.domElement);i.enableDamping=!0,i.dampingFactor=.06,i.rotateSpeed=.55,i.zoomSpeed=.74,i.minDistance=2.05,i.maxDistance=20,i.target.set(0,0,0),i.autoRotate=!0,i.autoRotateSpeed=.24,n.add(new Va(16761738,.15));let a=new za(16751146,28,40);a.position.set(4.8,2.7,4.2),n.add(a);let o=new za(16769197,12,35);o.position.set(-4.2,-.8,-2.2),n.add(o);let l=new za(4491519,3,30);l.position.set(-3,4,-5),n.add(l);let g=wu();n.add(g.skyDome,g.stars,g.gravityGrid,g.lightGeodesics,g.warpLines,g.lens,g.photonRing,g.iscoRing,g.disk,g.rim,g.horizon);let _=new au(t);_.addPass(new ou(n,r));let v=new cu(new U(e.clientWidth,e.clientHeight),1.4,.75,.35);_.addPass(v);let y=new nu(Su);y.uniforms.uStrength.value=0,y.uniforms.uRadius.value=.35,_.addPass(y);let b=new oo,x=new U,S=new W,C=0,w=(e,n)=>{let i=t.domElement.getBoundingClientRect();return x.x=(e-i.left)/i.width*2-1,x.y=-((n-i.top)/i.height)*2+1,b.setFromCamera(x,r),b.intersectObject(g.horizon,!1)[0]},T=()=>{C=performance.now()},E=e=>{w(e.clientX,e.clientY)&&h.current()},D=e=>{performance.now()-C>240||e.pointerType!==`mouse`&&w(e.clientX,e.clientY)&&h.current()};t.domElement.addEventListener(`pointerdown`,T),t.domElement.addEventListener(`pointerup`,D),t.domElement.addEventListener(`dblclick`,E);let O=()=>{let{clientWidth:n,clientHeight:i}=e;t.setSize(n,i,!1),_.setSize(n,i),r.aspect=n/Math.max(1,i),r.updateProjectionMatrix()},k=new ResizeObserver(O);k.observe(e),O();let A=new lo,ee=new W,te=new W(0,1,0),j=0,ne=m.current?.25:1,re=new W,M=new W,N=new W,P=()=>{let e=Math.min(.05,A.getDelta()),t=A.elapsedTime,n=c.current,a=bu(n.massSolar),o=n.spin,s=mu(o)/2,l=hu(o)/2,h=2*(1+Math.cos(2/3*Math.acos(-o)))/2,v=n.lensing/100,b=n.diskSpeed/100,x=d.current||f.current?.65:0,C=u.current,w=f.current,T=C&&p.current>0?Math.max(0,(performance.now()-p.current)/1e3)*ne:0,E=C?lu((T-1.7)/12,0,1):0,D=C?lu((T-2.6)/8.5,0,1):0,O=C?fu(lu((T-9.4)/5.6,0,1)):0,k=C?fu(lu((T-13.4)/2.9,0,1)):0,ie=du(.18,1.15,T),ae=1-du(5.35,7.25,T),oe=C?lu(ie*ae,0,1)*(m.current?.35:1):0;g.horizon.scale.setScalar(a*s),g.rim.scale.setScalar(a*s*(1.035+Math.sin(t*2)*.008)),g.lens.scale.setScalar(a*(2.95+v*1.75+x+D*.65)),g.disk.scale.setScalar(a*(.96+v*.05)),g.iscoRing.scale.setScalar(a*l),g.iscoRing.visible=!C,g.photonRing.scale.setScalar(a*h*.95),g.photonRing.visible=!C,g.photonRing.material.uniforms&&(g.photonRing.material.uniforms.uTime.value=t,g.photonRing.material.uniforms.uIntensity.value=.8+v*.5+E*.5),g.skyDome.material.uniforms.uTime.value=t*.05;let F=Math.min(_u,Math.round(n.particles));if(g.diskParticles.geometry.setDrawRange(0,F),g.disk.rotation.x=Math.PI*.12,g.disk.rotation.y+=e*(.18+b*1.65+E*1.4+O*11+k*20)*ne,g.disk.rotation.z=Math.sin(t*.23)*.025+O*.24,g.diskBands.forEach((t,n)=>{t.rotation.z+=e*(.18+b*(.75+n*.16)+O*(3.2+n*1.6)+k*(9+n*3.4))*ne,t.material.opacity=Fu(n,v,E)}),r.getWorldDirection(re),Mu(g.diskParticles,e,t,b,E,O,k,n.massSolar,o,F,r,re,M,N),Nu(g.gravityGrid,t,a*s,v,E,w),Pu(g.lightGeodesics,t,a*s,v,E),g.stars.rotation.y+=e*(.006+D*.05+O*.1)*ne,g.stars.rotation.x=Math.sin(t*.04)*.018,g.warpLines.rotation.y-=e*(.02+E*.25+O*.85)*ne,g.diskParticles.material.size=.027+v*.018+E*.018,g.stars.material.size=C?.038+D*.09+O*.05:.03,g.stars.material.opacity=C?.78+D*.18:.9,g.warpLines.material.opacity=C?D*.56:0,g.lens.material.uniforms.uTime.value=t,g.lens.material.uniforms.uIntensity.value=.3+v*1.18+x+D*.75,g.rim.material.uniforms.uTime.value=t,g.rim.material.uniforms.uIntensity.value=.72+E*.85,i.autoRotateSpeed=C?0:.12+b*.28,i.enabled=!C,C){let e=Math.sin(t*23)*.02*E;if(T<1.7)ee.set(0,a*2.9,a*14.2),r.position.lerp(ee,.08),r.up.lerp(te.set(0,1,0),.12);else{let n=fu(E),i=t*(.5+O*12+k*22),o=a*uu(.22,.025,O),s=uu(Math.sin(t*1.8)*a*.22*(1-n),Math.cos(i)*o,O),c=Math.sin(i*1.35)*o*.36,l=uu(a*14.2,a*(.68-O*.18),n),u=uu(a*2.9,a*.02,n)+c;ee.set(s+e,u+e*.3,l),r.position.lerp(ee,.055+n*.08+O*.04+k*.05),r.up.lerp(te.set(Math.sin(i*.42)*.7,1,Math.cos(i*.42)*.7),.05+O*.08)}i.target.lerp(yu,.18),r.lookAt(0,0,0)}else d.current||w?(ee.set(0,1.18,a*(w?4.2:4.45)),r.position.lerp(ee,.025),i.target.lerp(yu,.08),r.up.lerp(te.set(0,1,0),.08)):r.up.lerp(te.set(0,1,0),.06);i.update(),S.set(0,0,0),S.project(r),y.uniforms.uBlackHoleScreenPos.value.set((S.x+1)/2,(S.y+1)/2),y.uniforms.uStrength.value=.4+v*1.2+E*.8+oe*.55,y.uniforms.uRadius.value=.15+a*s*.12+oe*.18,y.uniforms.uTime.value=t,y.uniforms.uPsychedelic.value=oe,_.render(),j=window.requestAnimationFrame(P)};return P(),()=>{window.cancelAnimationFrame(j),k.disconnect(),t.domElement.removeEventListener(`pointerdown`,T),t.domElement.removeEventListener(`pointerup`,D),t.domElement.removeEventListener(`dblclick`,E),i.dispose(),_.dispose(),Iu(n),t.dispose(),t.domElement.remove()}},[]),(0,$.jsx)(`div`,{className:`scene-mount`,ref:s,"aria-label":`Buraco negro 3D interativo`,role:`img`})}function wu(){let e=new ui(new Yi(1,112,72),new Qr({color:0}));e.name=`event-horizon`;let t=new ui(new Yi(1.035,112,72),new aa({transparent:!0,depthWrite:!1,blending:2,side:1,uniforms:{uTime:{value:0},uIntensity:{value:.8}},vertexShader:`
        ...
        }`})),n=new ui(new Yi(3,112,72),new aa({transparent:!0,depthWrite:!1,blending:2,side:1,uniforms:{uTime:{value:0},uIntensity:{value:.75}},vertexShader:`
        varying vec3 vNormal; varying vec3 vWorld;
        void main() {
          vNormal = normalize(normalMatrix * normal);
          vec4 world = modelMatrix * vec4(position, 1.0);
        ...
        }`})),r=new ui(new Xi(1,.008,8,200),new Qr({color:65484,transparent:!0,opacity:.35,blending:2,depthWrite:!1}));r.rotation.x=Math.PI/2+Math.PI*.12;let i=new ui(new Ji(.95,1.15,128,1),new aa({transparent:!0,depthWrite:!1,blending:2,side:2,uniforms:{uTime:{value:0},uIntensity:{value:1}},vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
          gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        ...
        }`}));i.rotation.x=Math.PI/2+Math.PI*.12;let a=new zn;a.rotation.x=Math.PI*.12;let o=Eu();a.add(...o);let s=Du();return a.add(s),{horizon:e,rim:t,lens:n,iscoRing:r,photonRing:i,disk:a,diskBands:o,diskParticles:s,gravityGrid:Ou(),lightGeodesics:ku(),stars:Au(),warpLines:ju(),skyDome:Tu()}}function Tu(){return new ui(new Yi(180,64,64),new aa({side:1,depthWrite:!1,uniforms:{uTime:{value:0}},vertexShader:`
      varying vec3 vPosition;
      varying vec3 vNormal;
      void main() {
        vPosition = position;
      ...
      void main() {
        ...
        gl_FragColor = vec4(color, 1.0);
      }`}))}function Eu(){let e=[];for(let t of[{radius:1.34,color:16777215,opacity:.65,tube:.014},{radius:1.54,color:16769704,opacity:.6,tube:.018},{radius:1.9,color:16755254,opacity:.54,tube:.03},{radius:2.34,color:16739082,opacity:.45,tube:.046},{radius:2.95,color:10429444,opacity:.3,tube:.062}]){let n=new ui(new Xi(t.radius,t.tube,12,280),new Qr({color:t.color,transparent:!0,opacity:t.opacity,blending:2,depthWrite:!1}));n.rotation.x=Math.PI/2,n.userData.baseOpacity=t.opacity,e.push(n)}return e}function Du(){let e=new Float32Array(_u*3),t=new Float32Array(_u*3),n={radius:new Float32Array(_u),angle:new Float32Array(_u),height:new Float32Array(_u),speed:new Float32Array(_u),eccentricity:new Float32Array(_u),phase:new Float32Array(_u)},r=new K;for(let i=0;i<_u;i+=1){let a=1.18+Math.random()**.62*2.55,o=Math.random()*Math.PI*2,s=(Math.random()-.5)*.09,c=1-(a-1.18)/2.55;n.radius[i]=a,n.angle[i]=o,n.height[i]=s,n.speed[i]=.9+c*3.8+Math.random()*.35,n.eccentricity[i]=Math.random()*.025,n.phase[i]=Math.random()*Math.PI*2;let l=o+a*.26;e[i*3]=Math.cos(l)*a,e[i*3+1]=s,e[i*3+2]=Math.sin(l)*a;let u=c;r.setHSL(.045+u*.12,1,.39+u*.44),u>.82&&Math.random()>.36&&r.setRGB(1,.95,.85),t[i*3]=r.r,t[i*3+1]=r.g,t[i*3+2]=r.b}let i=new Vr;return i.setAttribute(`position`,new Er(e,3).setUsage(tt)),i.setAttribute(`color`,new Er(t,3).setUsage(tt)),i.setDrawRange(0,2800),i.userData.orbit=n,new Bi(i,new Fi({size:.034,sizeAttenuation:!0,vertexColors:!0,transparent:!0,opacity:.93,depthWrite:!1,blending:2}))}function Ou(){let e=[],t=[],n=1.05,r=8.7,i=(n,r)=>{e.push(n,0,r),t.push(n,r)};for(let e=0;e<20;e+=1){let t=n+e/19*(r-n);for(let e=0;e<112;e+=1){let n=e/112*Math.PI*2,r=(e+1)/112*Math.PI*2;i(Math.cos(n)*t,Math.sin(n)*t),i(Math.cos(r)*t,Math.sin(r)*t)}}for(let e=0;e<36;e+=1){let t=e/36*Math.PI*2;for(let e=0;e<14;e+=1){let a=n+e/14*(r-n),o=n+(r-n)*((e+1)/14);i(Math.cos(t)*a,Math.sin(t)*a),i(Math.cos(t)*o,Math.sin(t)*o)}}let a=new Vr;a.setAttribute(`position`,new Er(new Float32Array(e),3).setUsage(tt)),a.userData.grid={baseXZ:new Float32Array(t)};let o=new Pi(a,new Si({color:16757850,transparent:!0,opacity:.28,blending:2,depthWrite:!1}));return o.position.y=-.42,o}function ku(){let e=new zn,t=[-3.35,-2.75,-2.22,-1.74,-1.32,-.96,.96,1.32,1.74,2.22,2.75,3.35];return t.forEach((n,r)=>{let i=new Float32Array(vu*3),a=new Vr;a.setAttribute(`position`,new Er(i,3).setUsage(tt)),a.userData.geodesic={offset:n,height:(r-t.length/2)*.015,phase:r*.77};let o=new Si({color:r%3==0?16777215:16765578,transparent:!0,opacity:.22,blending:2,depthWrite:!1});e.add(new Ai(a,o))}),e}function Au(){let e=2800,t=new Float32Array(e*3),n=new Float32Array(e*3),r=new K;for(let i=0;i<e;i+=1){let e=22+Math.random()*92,a=Math.random()*Math.PI*2,o=Math.acos(2*Math.random()-1);t[i*3]=e*Math.sin(o)*Math.cos(a),t[i*3+1]=e*Math.cos(o),t[i*3+2]=e*Math.sin(o)*Math.sin(a),r.setHSL(.08+Math.random()*.06,.18,.7+Math.random()*.26),n[i*3]=r.r,n[i*3+1]=r.g,n[i*3+2]=r.b}let i=new Vr;return i.setAttribute(`position`,new Er(t,3)),i.setAttribute(`color`,new Er(n,3)),new Bi(i,new Fi({size:.03,vertexColors:!0,transparent:!0,opacity:.9,depthWrite:!1}))}function ju(){let e=new Float32Array(520*2*3);for(let t=0;t<520;t+=1){let n=Math.random()*Math.PI*2,r=7+Math.random()*24,i=(Math.random()-.5)*16,a=5+Math.random()*90,o=2.5+Math.random()*7,s=Math.cos(n)*r;e[t*6]=s,e[t*6+1]=i,e[t*6+2]=a,e[t*6+3]=s*.9,e[t*6+4]=i*.9,e[t*6+5]=a-o}let t=new Vr;return t.setAttribute(`position`,new Er(e,3)),new Pi(t,new Si({color:16764810,transparent:!0,opacity:0,blending:2,depthWrite:!1}))}function Mu(e,t,n,r,i,a,o,s,c,l,u,d,f,p){let m=e.geometry.getAttribute(`position`),h=m.array,g=e.geometry.getAttribute(`color`),_=g.array,v=e.geometry.userData.orbit,y=.55+r*5.4+i*4.2+a*18+o*34,b=Math.sqrt(Math.max(.01,s/43e5)),x=new K,S=c>=0?1:-1;for(let e=0;e<l;e+=1){let r=v.radius[e],s=1/r**1.5;v.angle[e]+=t*y*v.speed[e]*s*b*S;let c=i*(.09+.18*Math.sin(n*.9+v.phase[e]))+a*.18+o*.28,l=1+Math.sin(v.angle[e]*2+v.phase[e])*v.eccentricity[e],u=Math.max(1.05,(r-c)*l),m=v.angle[e]+u*.26,g=Math.cos(m)*u,C=v.height[e]+Math.sin(v.angle[e]*3+v.phase[e])*(.018+a*.08+o*.14),w=Math.sin(m)*u;h[e*3]=g,h[e*3+1]=C,h[e*3+2]=w;let T=lu(1/u,0,1),E=1-(r-1.18)/2.55;f.set(g,C,w);let D=m+Math.PI/2*S,O=s*y*.01;p.set(Math.cos(D)*O,0,Math.sin(D)*O);let k=lu(1+-p.dot(d)*2.5,.5,1.8),A=.045+E*.12-T*.04+(k-1)*.05,ee=lu((.39+E*.44+T*.1)*k,.1,.95);x.setHSL(lu(A,0,.15),1,ee),_[e*3]=x.r,_[e*3+1]=x.g,_[e*3+2]=x.b}m.needsUpdate=!0,g.needsUpdate=!0}function Nu(e,t,n,r,i,a){let o=e.geometry.getAttribute(`position`),s=o.array,{baseXZ:c}=e.geometry.userData.grid,l=.54+r*2.85+i*2.4,u=n*(1.85+r*1.35+i*.9),d=c.length/2;for(let e=0;e<d;e+=1){let i=c[e*2],a=c[e*2+1],o=Math.sqrt(i*i+a*a),d=Math.atan2(a,i),f=du(n*.72,n*1.38,o),p=-l*Math.exp(-o/u)/Math.sqrt(o+.18),m=Math.sin(d*8-t*.9)*.018*r*f;s[e*3]=i,s[e*3+1]=p*f+m,s[e*3+2]=a}o.needsUpdate=!0,e.material.opacity=a?.2+r*.18:.16+r*.3+i*.2}function Pu(e,t,n,r,i){let a=.22+r*1.2+i*.8;e.children.forEach(e=>{let o=e,s=o.geometry.getAttribute(`position`),c=s.array,l=o.geometry.userData.geodesic,u=Math.sign(l.offset)||1;for(let e=0;e<vu;e+=1){let i=e/(vu-1),o=i*2-1,s=o*8.4,d=l.offset,f=1-Math.abs(o),p=Math.sqrt(s*s+d*d),m=u*a*Math.exp(-Math.abs(s)/2.45)/(Math.abs(d)*.58+.55),h=u*a*f*f*.33/Math.max(.8,p),g=s*Math.cos(h)-(d-m)*Math.sin(h),_=s*Math.sin(h)+(d-m)*Math.cos(h),v=Math.sqrt(g*g+_*_),y=n*1.18,b=v<y?y/Math.max(.001,v):1;c[e*3]=g*b,c[e*3+1]=l.height+Math.sin(i*Math.PI*2+t*.7+l.phase)*.025*r,c[e*3+2]=_*b}s.needsUpdate=!0,o.material.opacity=.06+r*.2+i*.12}),e.rotation.y=Math.sin(t*.1)*.06}function Fu(e,t,n){let r=[.58,.52,.46,.38,.24][e]??.3;return Math.min(.78,r+t*.08+n*.1)}function Iu(e){e.traverse(e=>{let t=e;t.geometry&&`dispose`in t.geometry&&t.geometry.dispose(),t.material&&(Array.isArray(t.material)?t.material.forEach(e=>e.dispose()):t.material.dispose())})}function Lu({label:e,value:t,detail:n}){return(0,$.jsxs)(`div`,{className:`readout`,role:`group`,"aria-label":e,children:[(0,$.jsx)(`span`,{children:e}),(0,$.jsx)(`strong`,{"aria-live":`polite`,"aria-atomic":`true`,children:t}),n?(0,$.jsx)(`small`,{children:n}):null]})}var Ru=new Intl.NumberFormat(`pt-BR`,{maximumFractionDigits:2});function zu({label:e,value:t,min:n,max:r,step:i=1,unit:a,scale:o=`linear`,onChange:s,format:c=e=>Ru.format(e)}){let u=o===`log`?Math.log10(n):n,d=o===`log`?Math.log10(r):r,f=o===`log`?Math.log10(t):t,p=o===`log`?.01:i,m=(0,l.useMemo)(()=>c(t),[c,t]),h=a?`${m} ${a}`:m,g=e=>{let t=Number(e);s(o===`log`?10**t:t)};return(0,$.jsxs)(`label`,{className:`control-row`,children:[(0,$.jsxs)(`span`,{className:`control-header`,children:[(0,$.jsx)(`span`,{children:e}),(0,$.jsxs)(`strong`,{children:[m,a?`${a}`:``]})]}),(0,$.jsx)(`input`,{type:`range`,min:u,max:d,step:p,value:f,"aria-label":e,"aria-valuenow":t,"aria-valuemin":n,"aria-valuemax":r,"aria-valuetext":h,onChange:e=>g(e.target.value)})]})}var Bu={G:66743e-15,c:299792458,c2:299792458**2,Msun:198847e25,AU:149597870700,ly:9460730472580800};function Vu(e){let t=Gu(e);return 1+Math.sqrt(Math.max(0,1-t*t))}function Hu(e){let t=Gu(e);if(t<1e-9)return 6;let n=t*t,r=1+Math.cbrt(1-n)*(Math.cbrt(1+t)+Math.cbrt(1-t)),i=Math.sqrt(3*n+r*r);return 3+i-Math.sqrt(Math.max(0,(3-r)*(3+r+2*i)))}function Uu(e){let t=Gu(e);return 2*(1+Math.cos(2/3*Math.acos(-t)))}function Wu(e,t){let n=Gu(e);return Math.sqrt(1/t)/(1+n*(1/t)**1.5)}function Gu(e){return Math.min(.998,Math.max(0,e))}function Ku(e){let t=6371,n=696340;return e<t*2?`≈ ${(e/t).toFixed(2)} × raio da Terra`:e<n?`≈ ${(e/t).toFixed(0)} × raios da Terra`:e<n*10?`≈ ${(e/n).toFixed(2)} × raio do Sol`:e<Bu.AU/1e3?`≈ ${(e/n).toFixed(1)} × raios solares`:e<Bu.AU/1e3*100?`≈ ${(e/(Bu.AU/1e3)).toFixed(2)} UA`:`≈ ${(e/(Bu.ly/1e3)).toFixed(2)} anos-luz`}function qu(e){let t=e.massSolar*Bu.Msun,n=2*Bu.G*t/Bu.c2,r=n/1e3,i=Vu(e.spin),a=n/2*i,o=a/1e3,s=r,c=Hu(e.spin),l=n/2*c,u=l/1e3,d=c/2,f=Uu(e.spin),p=n/2*f/1e3,m=e.observerDistanceRs*n,h=1/Math.sqrt(Math.max(1e-6,1-n/m)),g=1/Math.sqrt(Math.max(1e-6,1-n/l))-1,_=Wu(e.spin,c);return{massKg:t,schwarzschildRadiusM:n,schwarzschildRadiusKm:r,eventHorizonDiameterKm:r*2,kerrHorizonRadiusM:a,kerrHorizonRadiusKm:o,ergosphereEquatorKm:s,photonSphereKm:p,iscoKm:u,iscoRs:d,farHoursForOneLocalHour:h,redshift:g,orbitalVelocityAtIsco:_,comparison:Ku(r)}}function Ju(e){return e<1?`${(e*1e3).toFixed(1)} m`:e<1e3?`${e.toFixed(1)} km`:e<1e6?`${(e/1e3).toFixed(2)} mil km`:e<Bu.AU/1e3?`${(e/1e6).toFixed(2)} milhões km`:e<Bu.ly/1e3?`${(e/(Bu.AU/1e3)).toFixed(2)} UA`:`${(e/(Bu.ly/1e3)).toFixed(3)} anos-luz`}function Yu(e,t){return new Intl.NumberFormat(`pt-BR`,{maximumFractionDigits:t,minimumFractionDigits:t}).format(e)}var Xu={sagittarius:{name:`Sagitário A*`,params:{massSolar:43e5,spin:.1,observerDistanceRs:10,diskSpeed:58,lensing:82,particles:2800}},m87:{name:`M87*`,params:{massSolar:65e8,spin:.9,observerDistanceRs:8,diskSpeed:72,lensing:90,particles:4200}},cygnus:{name:`Cygnus X-1`,params:{massSolar:21.2,spin:.95,observerDistanceRs:14,diskSpeed:85,lensing:75,particles:2400}},gw150914:{name:`GW150914 (fusão)`,params:{massSolar:62,spin:.67,observerDistanceRs:12,diskSpeed:80,lensing:95,particles:3500}},grs1915:{name:`GRS 1915+105`,params:{massSolar:14,spin:.98,observerDistanceRs:13,diskSpeed:92,lensing:78,particles:2600}},stellar:{name:`Massa estelar típica`,params:{massSolar:10,spin:.3,observerDistanceRs:14,diskSpeed:45,lensing:70,particles:2200}},schwarzschild:{name:`Schwarzschild (sem rotação)`,params:{massSolar:1e6,spin:0,observerDistanceRs:10,diskSpeed:50,lensing:80,particles:2800}}},Zu={massSolar:1e10,spin:.95,observerDistanceRs:1.1,diskSpeed:100,lensing:100,particles:5e3},Qu=26e3,$u={high:100,low:72},ed=1400,td=6200;function nd(e,t,n){try{let r=localStorage.getItem(e);return r===null?t:n(r)}catch{return t}}function rd(e){let[t,n]=(0,l.useState)(()=>typeof window<`u`?window.matchMedia(e).matches:!1);return(0,l.useEffect)(()=>{let t=window.matchMedia(e),r=e=>n(e.matches);return n(t.matches),t.addEventListener(`change`,r),()=>t.removeEventListener(`change`,r)},[e]),t}var id={pt:{eyebrow:`Black Hole Lab 3D`,title:`Buraco negro interativo.`,description:`Uma experiência com física Kerr real: horizonte dependente do spin, ISCO encolhendo até 0,5 Rs, Doppler boosting no disco, redshift gravitacional e geodésicas curvadas em tempo real.`,enter:`Entrar no Horizonte`,spectator:`Modo espectador`,force:`Forçar deformação`,forceActive:`Deformação forçada ✓`,panelToggleOpen:`Mostrar painel`,panelToggleClose:`Ocultar painel`,simulator:`Simulador`,panelTitle:`Horizonte de Eventos`,reset:`Reset`,presets:`Cenários reais`,mass:`Massa`,spin:`Spin (a*)`,spinDetail:`0 = Schwarzschild · 0,998 = limite de Thorne`,distance:`Distância do observador`,diskSpeed:`Velocidade do disco`,lensing:`Distorção gravitacional`,particles:`Partículas`,simulationNote:`Física Kerr real: o horizonte, ISCO e esfera de fótons mudam com o spin. O lado do disco que gira em direção à câmera fica mais brilhante (Doppler boosting).`,rs:`Raio de Schwarzschild`,kerrHorizon:`Horizonte Kerr (r+)`,kerrHorizonDetail:`r+ = M(1 + √(1-a*²))`,ergosphere:`Ergosfera (equador)`,ergosphereDetail:`r_E = 2M no equador`,photon:`Esfera de fótons`,photonDetail:`depende do spin`,isco:`ISCO`,iscoDetail:`órbita estável mais interna`,time:`Dilatação temporal`,timeDetail:`longe para cada 1 h local`,redshift:`Redshift no ISCO`,redshiftDetail:`z = 1/√(1-Rs/r) - 1`,vIsco:`Velocidade orbital no ISCO`,vIscoDetail:`fração de c`,spectatorButton:`Ativar modo espectador`,interaction:`Interação: arraste para girar, scroll para zoom, duplo toque no centro para entrar.`,shortcuts:`Atalhos: S (espectador) · L (idioma) · T (tema) · Esc (sair)`,spectatorHint:`Modo espectador ativo — sem HUD, só a simulação física visual`,credits:`Créditos`,createdBy:`Criado por Davi Mattos`,linkedin:`LinkedIn oficial`,language:`Idioma`,theme:`Tema`,dark:`Escuro`,light:`Claro`,comparisonFallback:`comparação visual aproximada`,theoryTitle:`Cálculos e teorias usadas`,theoryIntro:`Fórmulas e aproximações que alimentam a experiência visual.`,theoryItems:[{name:`Constantes físicas`,formula:`G = 6.67430×10⁻¹¹ | c = 299792458 m/s | M☉ = 1.98847×10³⁰ kg`,desc:`Base dos cálculos reais (CODATA 2018).`},{name:`Raio de Schwarzschild`,formula:`Rs = 2GM / c²`,desc:`Horizonte para buraco sem rotação nem carga.`},{name:`Métrica de Kerr`,formula:`r+ = M(1 + √(1-a*²))`,desc:`Horizonte externo para buraco rotacionando com spin adimensional a*.`},{name:`ISCO (Bardeen 1972)`,formula:`Z1, Z2 → r_isco = 3 + Z2 - √((3-Z1)(3+Z1+2Z2))`,desc:`Órbita estável mais interna. Para a*=0 → 6M; para a*=1 → M (prógrado).`},{name:`Esfera de fótons Kerr`,formula:`r_ph = 2M(1 + cos(⅔ arccos(-a*)))`,desc:`Região onde luz orbita temporariamente.`},{name:`Ergosfera`,formula:`r_E(θ) = M + √(M² - a²cos²θ)`,desc:`Região onde nenhum observador pode permanecer estático.`},{name:`Velocidade orbital no ISCO`,formula:`v = √(M/r) / (1 + a(M/r)^(3/2))`,desc:`Fração da velocidade da luz no ISCO prógrado.`},{name:`Doppler boosting`,formula:`I ∝ (1 - v·n/c)^(-3)`,desc:`Lado do disco que gira em direção ao observador fica mais brilhante e azulado.`},{name:`Redshift gravitacional`,formula:`z = 1/√(1-Rs/r) - 1`,desc:`Luz perde energia ao escapar de regiões próximas ao horizonte.`},{name:`Dilatação temporal`,formula:`√(1 - Rs/r)`,desc:`Tempo local diverge do observador distante.`},{name:`Limite de Thorne`,formula:`a* ≤ 0.998`,desc:`Limite teórico para spin de buracos negros astrofísicos (acoplamento com disco).`}],spaghettifyText:`ESPAGUETIFICAÇÃO  GRAVIDADE QUÂNTICA  SINGULARIDADE`,crawlTitle:`Entrada no horizonte de eventos`,psychedelicWarningTitle:`Aviso de efeito psicodélico`,psychedelicWarningText:`A imersão usa distorções intensas, flashes suaves, rotação e sensação de queda. Se sentir desconforto, pressione Esc para sair.`,crawlMessages:[{label:`Impulso inicial`,text:`A câmera é arremessada para longe para revelar a escala do poço gravitacional.`},{label:`Atração gravitacional`,text:`A gravidade domina a trajetória. A queda deixa de ser escolha e vira destino.`},{label:`Luz curvada`,text:`A luz do disco é desviada pelo campo gravitacional extremo.`},{label:`Tempo em desacordo`,text:`Para observadores distantes, o tempo perto do horizonte desacelera.`},{label:`Horizonte de eventos`,text:`Ao cruzar essa fronteira, nenhum sinal volta. Nem a luz.`},{label:`Rotação extrema`,text:`A aproximação acelera a percepção visual, reforçando o colapso.`},{label:`Limite quântico`,text:`Perto da singularidade, a Relatividade Geral já não basta.`}],crawlFooter:`Representação artística e educativa inspirada na Relatividade Geral e na métrica de Kerr.`},en:{eyebrow:`Black Hole Lab 3D`,title:`Interactive black hole.`,description:`A real-Kerr physics experience: spin-dependent horizon, ISCO shrinking to 0.5 Rs, Doppler boosting on the disk, gravitational redshift, and curved geodesics in real time.`,enter:`Enter the Horizon`,spectator:`Spectator mode`,force:`Force distortion`,forceActive:`Distortion forced ✓`,panelToggleOpen:`Show panel`,panelToggleClose:`Hide panel`,simulator:`Simulator`,panelTitle:`Event Horizon`,reset:`Reset`,presets:`Real scenarios`,mass:`Mass`,spin:`Spin (a*)`,spinDetail:`0 = Schwarzschild · 0.998 = Thorne limit`,distance:`Observer distance`,diskSpeed:`Disk speed`,lensing:`Gravitational distortion`,particles:`Particles`,simulationNote:`Real Kerr physics: horizon, ISCO and photon sphere change with spin. The disk side rotating toward the camera appears brighter (Doppler boosting).`,rs:`Schwarzschild radius`,kerrHorizon:`Kerr horizon (r+)`,kerrHorizonDetail:`r+ = M(1 + √(1-a*²))`,ergosphere:`Ergosphere (equator)`,ergosphereDetail:`r_E = 2M at equator`,photon:`Photon sphere`,photonDetail:`spin-dependent`,isco:`ISCO`,iscoDetail:`innermost stable orbit`,time:`Time dilation`,timeDetail:`far away for each 1 local hour`,redshift:`Redshift at ISCO`,redshiftDetail:`z = 1/√(1-Rs/r) - 1`,vIsco:`Orbital velocity at ISCO`,vIscoDetail:`fraction of c`,spectatorButton:`Activate spectator mode`,interaction:`Interaction: drag to rotate, scroll to zoom, double tap the center to enter.`,shortcuts:`Shortcuts: S (spectator) · L (language) · T (theme) · Esc (exit)`,spectatorHint:`Spectator mode active — no HUD, only the visual physics simulation`,credits:`Credits`,createdBy:`Created by Davi Mattos`,linkedin:`Official LinkedIn`,language:`Language`,theme:`Theme`,dark:`Dark`,light:`Light`,comparisonFallback:`approximate visual comparison`,theoryTitle:`Calculations and theories used`,theoryIntro:`Formulas and approximations powering the visual experience.`,theoryItems:[{name:`Physical constants`,formula:`G = 6.67430×10⁻¹¹ | c = 299792458 m/s | M☉ = 1.98847×10³⁰ kg`,desc:`Real calculation basis (CODATA 2018).`},{name:`Schwarzschild radius`,formula:`Rs = 2GM / c²`,desc:`Horizon for non-rotating, uncharged black hole.`},{name:`Kerr metric`,formula:`r+ = M(1 + √(1-a*²))`,desc:`Outer horizon for rotating black hole with dimensionless spin a*.`},{name:`ISCO (Bardeen 1972)`,formula:`Z1, Z2 → r_isco = 3 + Z2 - √((3-Z1)(3+Z1+2Z2))`,desc:`Innermost stable orbit. For a*=0 → 6M; for a*=1 → M (prograde).`},{name:`Kerr photon sphere`,formula:`r_ph = 2M(1 + cos(⅔ arccos(-a*)))`,desc:`Region where light orbits temporarily.`},{name:`Ergosphere`,formula:`r_E(θ) = M + √(M² - a²cos²θ)`,desc:`Region where no observer can remain static.`},{name:`Orbital velocity at ISCO`,formula:`v = √(M/r) / (1 + a(M/r)^(3/2))`,desc:`Fraction of light speed at prograde ISCO.`},{name:`Doppler boosting`,formula:`I ∝ (1 - v·n/c)^(-3)`,desc:`Disk side rotating toward observer appears brighter and bluer.`},{name:`Gravitational redshift`,formula:`z = 1/√(1-Rs/r) - 1`,desc:`Light loses energy escaping near the horizon.`},{name:`Time dilation`,formula:`√(1 - Rs/r)`,desc:`Local time diverges from distant observer.`},{name:`Thorne limit`,formula:`a* ≤ 0.998`,desc:`Theoretical limit for astrophysical black hole spin (disk coupling).`}],spaghettifyText:`SPAGHETTIFICATION  QUANTUM GRAVITY  SINGULARITY`,crawlTitle:`Crossing the event horizon`,psychedelicWarningTitle:`Psychedelic effect warning`,psychedelicWarningText:`This immersion uses intense distortion, soft flashes, rotation and falling motion. If you feel discomfort, press Esc to exit.`,crawlMessages:[{label:`Initial impulse`,text:`The camera is thrown far to reveal the gravitational well scale.`},{label:`Gravitational pull`,text:`Gravity now dominates. The fall becomes destiny.`},{label:`Curved light`,text:`Disk light is bent by the extreme gravitational field.`},{label:`Time disagreement`,text:`For distant observers, time near the horizon slows down.`},{label:`Event horizon`,text:`Once crossed, no signal returns. Not even light.`},{label:`Extreme rotation`,text:`The final approach accelerates visual perception.`},{label:`Quantum limit`,text:`Near the singularity, General Relativity is no longer enough.`}],crawlFooter:`Artistic and educational representation inspired by General Relativity and the Kerr metric.`}};function ad(){let[e,t]=(0,l.useState)(Xu.sagittarius.params),[n,r]=(0,l.useState)(()=>nd(`bh.panel`,!0,e=>e!==`0`)),[i,a]=(0,l.useState)(!1),[o,s]=(0,l.useState)(!1),[c,u]=(0,l.useState)(!1),[d,f]=(0,l.useState)(0),[p,m]=(0,l.useState)(()=>nd(`bh.locale`,`pt`,e=>e===`en`?`en`:`pt`)),[h,g]=(0,l.useState)(()=>nd(`bh.theme`,`dark`,e=>e===`light`?`light`:`dark`)),[_,v]=(0,l.useState)(!1),[y,b]=(0,l.useState)(!1),x=rd(`(prefers-reduced-motion: reduce)`),S=(0,l.useRef)(null),C=id[p],w=(0,l.useMemo)(()=>qu(e),[e]),T=(0,l.useMemo)(()=>Array.from(C.spaghettifyText),[C]);(0,l.useEffect)(()=>{try{localStorage.setItem(`bh.panel`,n?`1`:`0`)}catch{}},[n]),(0,l.useEffect)(()=>{try{localStorage.setItem(`bh.locale`,p)}catch{}},[p]),(0,l.useEffect)(()=>{try{localStorage.setItem(`bh.theme`,h)}catch{}},[h]);let E=(0,l.useCallback)((e,n)=>{t(t=>({...t,[e]:n}))},[]),D=(0,l.useCallback)(e=>{i||(S.current=null,t(e))},[i]),O=(0,l.useCallback)(()=>{i||(S.current||=e,t(Zu),s(!0),a(!0),r(!1),u(!0),b(!0),f(performance.now()))},[e,i]),k=(0,l.useCallback)(()=>{s(!1),a(!1),f(0),u(!1),b(!1),r(!0),S.current&&=(t(S.current),null)},[]),A=(0,l.useCallback)(()=>{E(`lensing`,e.lensing>=$u.high-4?$u.low:$u.high),v(!0),window.setTimeout(()=>v(!1),ed)},[e.lensing,E]);return(0,l.useEffect)(()=>{let e=e=>{let t=e.target;if(t?.tagName===`INPUT`||t?.tagName===`TEXTAREA`)return;let n=e.key.toLowerCase();n===`s`?u(e=>!e):n===`l`?m(e=>e===`pt`?`en`:`pt`):n===`t`?g(e=>e===`dark`?`light`:`dark`):n===`escape`&&(c&&u(!1),i&&k())};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[i,k,c]),(0,l.useEffect)(()=>{if(!i||!y)return;let e=window.setTimeout(()=>b(!1),td);return()=>window.clearTimeout(e)},[i,y]),(0,l.useEffect)(()=>{if(!i||d<=0)return;let e=window.setTimeout(()=>k(),Qu);return()=>window.clearTimeout(e)},[i,d,k]),(0,$.jsxs)(`main`,{className:`app theme-${h}${i?` entering`:``}${y?` psychedelic-active`:``}${c?` spectator`:``}${x?` reduced-motion`:``}`,children:[(0,$.jsx)(Cu,{params:e,entering:i,horizonFocus:o,spectatorMode:c,sequenceStartedAt:d,reducedMotion:x,onDoubleTapHorizon:O}),(0,$.jsxs)(`section`,{className:`hero-copy`,"aria-label":`Introdução`,children:[(0,$.jsx)(`p`,{className:`eyebrow`,children:C.eyebrow}),(0,$.jsx)(`h1`,{children:C.title}),(0,$.jsx)(`p`,{children:C.description}),(0,$.jsxs)(`div`,{className:`hero-actions`,children:[(0,$.jsx)(`button`,{onClick:O,disabled:i,children:C.enter}),(0,$.jsx)(`button`,{className:`ghost`,onClick:()=>u(!0),children:C.spectator}),(0,$.jsx)(`button`,{className:`ghost${_?` flash`:``}`,onClick:A,children:_?C.forceActive:C.force})]})]}),(0,$.jsxs)(`div`,{className:`top-controls`,"aria-label":`Opções globais`,children:[(0,$.jsxs)(`div`,{className:`toggle-group`,role:`radiogroup`,"aria-label":C.language,children:[(0,$.jsx)(`span`,{children:C.language}),(0,$.jsx)(`button`,{role:`radio`,"aria-checked":p===`pt`,className:p===`pt`?`active`:``,onClick:()=>m(`pt`),children:`PT`}),(0,$.jsx)(`button`,{role:`radio`,"aria-checked":p===`en`,className:p===`en`?`active`:``,onClick:()=>m(`en`),children:`EN`})]}),(0,$.jsxs)(`div`,{className:`toggle-group`,role:`radiogroup`,"aria-label":C.theme,children:[(0,$.jsx)(`span`,{children:C.theme}),(0,$.jsx)(`button`,{role:`radio`,"aria-checked":h===`dark`,className:h===`dark`?`active`:``,onClick:()=>g(`dark`),children:C.dark}),(0,$.jsx)(`button`,{role:`radio`,"aria-checked":h===`light`,className:h===`light`?`active`:``,onClick:()=>g(`light`),children:C.light})]})]}),(0,$.jsx)(`button`,{className:`panel-toggle`,onClick:()=>r(e=>!e),"aria-expanded":n,children:n?C.panelToggleClose:C.panelToggleOpen}),(0,$.jsxs)(`aside`,{className:n?`lab-panel open`:`lab-panel`,"aria-label":`Controles do buraco negro`,children:[(0,$.jsxs)(`div`,{className:`panel-header`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:C.simulator}),(0,$.jsx)(`h2`,{children:C.panelTitle})]}),(0,$.jsx)(`button`,{onClick:k,children:C.reset})]}),(0,$.jsxs)(`div`,{className:`presets`,role:`group`,"aria-label":C.presets,children:[(0,$.jsx)(`span`,{children:C.presets}),(0,$.jsx)(`div`,{className:`preset-row`,children:Object.entries(Xu).map(([e,t])=>(0,$.jsx)(`button`,{onClick:()=>D(t.params),children:t.name},e))})]}),(0,$.jsxs)(`div`,{className:`controls`,children:[(0,$.jsx)(zu,{label:C.mass,min:1,max:1e10,value:e.massSolar,unit:`M☉`,scale:`log`,format:e=>Yu(e,0),onChange:e=>E(`massSolar`,Math.round(e))}),(0,$.jsx)(zu,{label:C.spin,min:0,max:.998,step:.001,value:e.spin,format:e=>Yu(e,3),onChange:e=>E(`spin`,Number(e.toFixed(3)))}),(0,$.jsx)(zu,{label:C.distance,min:1.1,max:50,step:.1,value:e.observerDistanceRs,unit:`Rs`,format:e=>Yu(e,1),onChange:e=>E(`observerDistanceRs`,Number(e.toFixed(1)))}),(0,$.jsx)(zu,{label:C.diskSpeed,min:0,max:100,value:e.diskSpeed,unit:`%`,onChange:e=>E(`diskSpeed`,Math.round(e))}),(0,$.jsx)(zu,{label:C.lensing,min:0,max:100,value:e.lensing,unit:`%`,onChange:e=>E(`lensing`,Math.round(e))}),(0,$.jsx)(zu,{label:C.particles,min:300,max:5e3,step:50,value:e.particles,format:e=>Yu(e,0),onChange:e=>E(`particles`,Math.round(e))})]}),(0,$.jsx)(`p`,{className:`simulation-note`,children:C.simulationNote}),(0,$.jsxs)(`div`,{className:`readout-grid`,role:`region`,"aria-label":`Métricas calculadas`,children:[(0,$.jsx)(Lu,{label:C.rs,value:Ju(w.schwarzschildRadiusKm),detail:w.comparison}),(0,$.jsx)(Lu,{label:C.kerrHorizon,value:Ju(w.kerrHorizonRadiusKm),detail:C.kerrHorizonDetail}),(0,$.jsx)(Lu,{label:C.photon,value:Ju(w.photonSphereKm),detail:C.photonDetail}),(0,$.jsx)(Lu,{label:C.isco,value:`${Yu(w.iscoRs,3)} Rs · ${Ju(w.iscoKm)}`,detail:C.iscoDetail}),(0,$.jsx)(Lu,{label:C.vIsco,value:`${Yu(w.orbitalVelocityAtIsco*100,1)}% c`,detail:C.vIscoDetail}),(0,$.jsx)(Lu,{label:C.time,value:`${Yu(w.farHoursForOneLocalHour,2)} h`,detail:C.timeDetail}),(0,$.jsx)(Lu,{label:C.redshift,value:`z = ${Yu(w.redshift,3)}`,detail:C.redshiftDetail})]}),(0,$.jsxs)(`section`,{className:`theory-section`,"aria-label":C.theoryTitle,children:[(0,$.jsxs)(`div`,{className:`theory-header`,children:[(0,$.jsx)(`span`,{children:C.theoryTitle}),(0,$.jsx)(`p`,{children:C.theoryIntro})]}),(0,$.jsx)(`div`,{className:`theory-list`,children:C.theoryItems.map(e=>(0,$.jsxs)(`article`,{className:`theory-item`,children:[(0,$.jsx)(`strong`,{children:e.name}),(0,$.jsx)(`code`,{children:e.formula}),(0,$.jsx)(`p`,{children:e.desc})]},`${p}-${e.name}`))})]}),(0,$.jsx)(`button`,{className:`wide-action`,onClick:()=>u(!0),children:C.spectatorButton}),(0,$.jsxs)(`div`,{className:`credits-card`,children:[(0,$.jsx)(`span`,{children:C.credits}),(0,$.jsx)(`strong`,{children:C.createdBy}),(0,$.jsx)(`a`,{href:`https://www.linkedin.com/in/davinmattos/`,target:`_blank`,rel:`noreferrer`,children:C.linkedin})]})]}),(0,$.jsxs)(`div`,{className:`bottom-note`,children:[(0,$.jsxs)(`strong`,{children:[C.credits,`:`]}),` `,C.createdBy,` — `,(0,$.jsx)(`a`,{href:`https://www.linkedin.com/in/davinmattos/`,target:`_blank`,rel:`noreferrer`,children:C.linkedin}),(0,$.jsx)(`br`,{}),C.interaction,(0,$.jsx)(`br`,{}),(0,$.jsx)(`kbd`,{children:C.shortcuts})]}),c&&!i?(0,$.jsx)(`div`,{className:`spectator-hint`,role:`status`,"aria-live":`polite`,children:C.spectatorHint}):null,i?(0,$.jsxs)(`div`,{className:`horizon-overlay`,role:`status`,"aria-label":C.crawlTitle,children:[y?(0,$.jsxs)(`div`,{className:`psychedelic-warning`,role:`alert`,"aria-live":`assertive`,children:[(0,$.jsx)(`span`,{children:C.psychedelicWarningTitle}),(0,$.jsx)(`strong`,{children:C.psychedelicWarningText})]}):null,(0,$.jsx)(`div`,{className:`crawl-mask`,children:(0,$.jsxs)(`div`,{className:`crawl-track`,children:[(0,$.jsx)(`p`,{className:`crawl-kicker`,children:C.crawlTitle}),C.crawlMessages.map(e=>(0,$.jsxs)(`p`,{className:`crawl-line`,children:[(0,$.jsx)(`span`,{children:e.label}),e.text]},`${p}-${e.label}`)),(0,$.jsx)(`p`,{className:`crawl-footer`,children:C.crawlFooter})]})}),(0,$.jsx)(`div`,{className:`spaghettify-layer`,"aria-hidden":`true`,children:T.map((e,t)=>(0,$.jsx)(`span`,{style:{"--i":t,"--a":`${t/Math.max(1,T.length)*360}deg`,"--r":`${180+t%22*9}px`},children:e===` `?` `:e},`${p}-letter-${t}`))})]}):null]})}(0,u.createRoot)(document.getElementById(`root`)).render((0,$.jsx)(l.StrictMode,{children:(0,$.jsx)(ad,{})}));